...
def main():
    ...
    if args.sample_size > 0:
        txt_file_train_l = txt_file_train.sample(args.sample_size, random_state=107)
    else:
        txt_file_train_l = txt_file_train
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        }, is_best,filename=f'checkpoint_{args.sample_size}.pth.tar',
        filename_best_model=f'modelbest_{args.sample_size}.pth.tar'
...
if __name__ == "__main__":
    ...
    parser.add_argument('--sample_size', default=-1, type=int, help='Sample Size to Downsample training set')
