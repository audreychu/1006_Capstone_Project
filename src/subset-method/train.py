...
def main():
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        print(len(labeled_ix), len(unlabeled_ix), len(full_indices))

        train_subset = Subset(train_dataset, labeled_ix)
        ...
        labeled_ix = labeled_ix.union(random.sample(unlabeled_ix, 1))
        unlabeled_ix = full_indices.difference(labeled_ix)
